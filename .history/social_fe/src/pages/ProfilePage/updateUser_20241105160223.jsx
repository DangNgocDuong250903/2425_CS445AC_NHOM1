...
const UpdateUser = () => {
    ...
    useEffect(() => {
        if (selectedLink === 1) {
            // Thực hiện logic khác khi "Chỉnh sửa trang cá nhân" được chọn
            // Ví dụ: bạn có thể thêm code thay đổi màu sắc tại đây
        }
    }, [selectedLink]);
    return (
        <div className="flex w-[800px] mx-auto pt-10 pb-10 border border-gray-200 shadow-md rounded-lg ">
            <IoIosCloseCircleOutline onClick={() => navigate("/Profile")} className="absolute w-8 h-8 cursor-pointer top-10 right-[400px] hover:text-red-400 " />
