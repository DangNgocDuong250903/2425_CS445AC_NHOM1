        ...
        <div className="flex w-[800px] mx-auto pt-10 pb-10 border border-gray-200 shadow-md rounded-lg ">
            ...
            <div className="w-1/3 p-4 bg-white rounded-md ">
                <ul className="flex flex-col ">
                    ...
                    <Link
                        ...
                        className={`mb-4 font-medium hover:bg-gray-200 ${selectedLink === 1 ? 'text-blue-500' : 'text-gray-700'}`}
                    >
                    ...
                    <Link 
                        ...
                        className={`mb-4 font-medium hover:bg-gray-200 px-3 py-2 round ${selectedLink === 2 ? 'text-blue-500' : 'text-gray-700'}`}
                    >
                        Đổi mật khẩu
                    </Link>
                    ...
                    <Link
                        ...
                        className={`mb-4 font-medium hover:bg-gray-200 ${selectedLink === 3 ? 'text-blue-500' : 'text-gray-700'}`}
                    >
                        Trợ giúp
                    </Link>
                </ul>
            ...
            <div className="w-3/4 p-8">
                ...
                <form>
                    ...
                    <div className="flex items-center">
                        <button type="submit" className="px-4 py-2 mr-4 font-semibold text-blue-400 bg-transparent border border-gray-300 rounded hover:text-white hover:bg-blue-400">Gửi</button>
