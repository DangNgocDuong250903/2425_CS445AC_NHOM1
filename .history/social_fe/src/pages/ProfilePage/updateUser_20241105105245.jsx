    ...
    return (
        <div className="flex w-[800px] mx-auto pt-10 pb-10">
            <div className="w-1/3 p-4 bg-gray-200">
                <ul>
                    <Link className="mb-4"><a href="#" className="text-blue-500">Chỉnh sửa trang cá nhân</a></Link>
                    <Link className="mb-4"><a href="#">Đổi mật khẩu</a></Link>
                    <Link className="mb-4"><a href="#">Trợ giúp</a></Link>
                </ul>
            </div>
