        ...
        <div className="flex w-[800px] mx-auto mt-20 pb-10 border border-gray-200 shadow-md rounded-lg">
            ...
            <div className="w-3/4 p-8">
                ...
                <div className="flex gap-5 mb-4">
                    <label className="max-w-[200px] mb-2">Mật khẩu cũ:</label>
                    <input type="password" className="flex-1 px-2 border" />
                </div>
                <div className="flex gap-5 mb-4">
                    <label className="mb-2 max-w-[200px] ">Mật khẩu mới:</label>
                    <input type="password" className="flex-1 px-2 border" />
                </div>
                <div className="flex gap-5 mb-4">
                    <label className="mb-2 max-w-[200px] ">Xác nhận mật khẩu mới:</label>
                    <input type="password" className="flex-grow px-2 border" />
                </div>
