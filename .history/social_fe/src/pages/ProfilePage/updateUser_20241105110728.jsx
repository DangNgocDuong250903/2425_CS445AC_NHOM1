        ...
        <div className="flex w-[800px] mx-auto pt-10 pb-10 border border-gray-200 shadow-md rounded-lg ">
            ...
            <div className="w-3/4 p-8">
                ...
                <form>
                    ...
                    <div className="flex items-center">
                        <button type="submit" className="px-4 py-2 mr-4 font-semibold text-blue-400 bg-transparent border border-gray-300 rounded hover:text-w hover:bg-blue-400">Gửi</button>
