    ...
    <div className="flex items-center justify-center pt-20">
      <div className="relative p-6 bg-white rounded-lg shadow-md w-[700px] h-[600px] border border-gray-400">
        ...
        <div className="flex justify-between mt-10 text-gray-400 cursor-pointer ">
          <td className=" font-semibold hover:text-black hover:shadow-[0_3px_0_-1px] px-2">Bảng tin</td>
          <td className="font-semibold hover:text-black hover:shadow-[0_3px_0_-1px] px-2">Trả lời </td>
          <td className="font-semibold hover:text-black hover:shadow-[0_3px_0_-1px] px-2">Đăng lại</td>
        </div>
      </div>
      {/*  */}
    </div>
