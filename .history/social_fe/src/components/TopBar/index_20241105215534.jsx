    ...
    <div className="flex items-center justify-between w-full px-4 py-3 topbar md:py-6 bg-primary">
      ...
      <div className="flex items-center gap-4 text-base text-ascent-1 md:text-xl">
        ...
        <Popover className="relative">
          ...
          <PopoverPanel className="absolute right-0 z-10 p-3 transition-opacity duration-200 ease-in-out bg-white rounded-lg shadow-lg w-[200px] h-[100px] ">
            <div className="flex flex-col items-start p-2 space-y-2 text-sm cursor-pointe ">
              ...
              <Link
                ...
                containerStyles="text-sm text-ascent-1 px-4 md:px-6 py-1 md:py-2 border border-[#666] rounded-full">Đăng Xuất</Link>
            </div>
          </PopoverPanel>
        </Popover>
      </div>
