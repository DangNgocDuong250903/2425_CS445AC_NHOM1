        ...
        <Popover className="relative">
          ...
          <PopoverPanel className="absolute right-0 z-10 w-48 p-3 transition-opacity duration-200 ease-in-out bg-white rounded-lg shadow-lg ">
            <div className="flex flex-col items-start text-sm cursor-pointer ">
              <Link to='/products' className="w-full text-left text-gray-500 hover:bg-gray-100">Trang cá nhân</Link>
              <Link to='/setting' className="w-full text-left text-gray-500 hover:bg-gray-100">Settings</Link>
              <Link to='/' className="w-full text-left text-gray-500 hover:bg-gray-100">Log out</Link>
            </div>
