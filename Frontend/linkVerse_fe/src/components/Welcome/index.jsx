    ...
    <DialogCustom isOpen={show} handleCloseDiaLogAdd={handleClose}>
      <div className="w-full px-2 py-14 text-center gap-y-7 flex-col rounded-2xl flex items-center justify-center">
        ...
        <button
          ...
          className="text-white bg-[#2557D6]  hover:scale-105 transition-transform focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center justify-center"
        >
