                    ...
                    <div className="flex">
                        ...
                        <div className='flex-1 ml-4 '>
                            ...
                            <div className='flex flex-col'>
                                <span>{item.follow} follow</span>
                            </div>
                        </div>
                        <div className='flex flex-col'>
                            <div className='text-base text-gray-400 center text-'>{item.post}</div>
                            <span className={`text-sm font-semibold ${item.status === "online" ? "text-green-500" : "text-gray-500"}`}>{item.status}</span>
                        </div>
                    </div>
                ))}
            </div>
